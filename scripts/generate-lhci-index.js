...
// Written by scripts/fetch-newrelic-inp.js, outside REPORTS_DIR since everything under it
// gets deployed to Cloudflare Pages — the raw per-brand payload should stay off the public site.
const NEWRELIC_INP_PATH = path.join(__dirname, '..', 'newrelic-reports', 'inp.json');

// Below this many sessions, a p75 is one or a handful of real users — color-coding it as
// Good/Needs improvement/Poor would present confidence the sample doesn't support.
