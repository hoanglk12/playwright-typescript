...
**Working style:** Prefers extremely terse interactions — gives short commands like "implement 1,2,3" expecting Claude to execute without narration. Does not want step-by-step explanation of obvious things. Trusts Claude to make reasonable judgment calls.
