...
- [Project Context](project_context.md) — Composition-based POM; GitHub Actions CI; monocart + Slack; Cloudflare Pages report hosting; PLA GraphQL API tests (5 specs, staging Magento 2)
