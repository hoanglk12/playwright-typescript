...
- [Project Context](project_context.md) — Composition-based POM; GitHub Actions CI; monocart + Slack; Cloudflare Pages; PLA GraphQL API (15 specs, api-test-helpers.ts, createPlaTestData()); Ecommerce UI smoke (6 specs, ~200 tests, smoke-helpers.ts)
