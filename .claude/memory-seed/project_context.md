...
**PLA (Platypus Shoes) GraphQL API tests (added 2026-05-15, expanded 2026-05-19):**
- Target: `https://stag-platypus-au.accentgra.com/graphql` (Magento 2 / Adobe Commerce)
- 7 spec files in `tests/api/`: `pla-account-creation-signin`, `pla-cart_minicart`, `pla-my-details`, `pla-support-features`, `pla-authentication`, `pla-search`, `pla-customer-profile`
...
- `api-scenarios-report.html` at project root: 38 GraphQL operations documented, 25 covered, 13 gaps — see [[pla-api-testing]] for patterns and API quirks
