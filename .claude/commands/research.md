---
description: Research a technical topic, integration, or upgrade — invokes technical-research-agent and produces a structured Technical Research Report
---
...
Then research the topic from $ARGUMENTS. Common categories include:
...
- **Implementation steps** — ordered action list (for the implementation agent to follow)
