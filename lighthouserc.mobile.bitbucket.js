...
/**
 * Lighthouse CI configuration — mobile form factor (Slow 4G, mobile emulation),
 * Bitbucket Pipelines port. Scoped to Platypus only (not all 8 GRA storefronts) to fit the Bitbucket
 * workspace's Free-tier build-minute budget (50 min/month). lighthouserc.mobile.js
 * (used by the GitHub Actions workflow) still audits all 8 storefronts.
 *
 * Run locally: npx lhci collect --config=lighthouserc.mobile.bitbucket.js
 */
