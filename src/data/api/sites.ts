...
export const siteRegistry: Record<string, SiteContext> = {
  ...
  'pla-nz': {
    siteCode: 'pla-nz',
    brand: 'platypus',
    baseURL: 'https://stag-platypus-nz.accentgra.com/graphql',
    storeHeader: 'nz',
    countryCode: 'NZ',
    currency: 'NZD',
    ...
    catalogSearchTerm: 'shoe',
    hasLoyalty: true,
    testData: createBrandTestData('pla-nz'),
  },
  'skx-nz': {
    siteCode: 'skx-nz',
    brand: 'skechers',
    baseURL: 'https://stag-skechers-nz.accentgra.com/graphql',
    storeHeader: 'nz',
    countryCode: 'NZ',
    currency: 'NZD',
    shippingRegion: 'Auckland',
    catalogSearchTerm: 'skechers',
    hasLoyalty: true,
    testData: createBrandTestData('skx-nz'),
  },
  'drm-nz': {
    siteCode: 'drm-nz',
    brand: 'drmartens',
    baseURL: 'https://stag-drmartens-nz.accentgra.com/graphql',
    storeHeader: 'nz',
    countryCode: 'NZ',
    currency: 'NZD',
    shippingRegion: 'Auckland',
    catalogSearchTerm: 'boot',
    hasLoyalty: false,
    testData: createBrandTestData('drm-nz'),
  },
  'van-nz': {
    siteCode: 'van-nz',
    brand: 'vans',
    baseURL: 'https://stag-vans-nz.accentgra.com/graphql',
    storeHeader: 'nz',
    countryCode: 'NZ',
    currency: 'NZD',
    shippingRegion: 'Auckland',
    catalogSearchTerm: 'vans',
    hasLoyalty: false,
    testData: createBrandTestData('van-nz'),
  },
};
